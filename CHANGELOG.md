...
### Fixed
- 3D Sky View: `window._perAcSmooth` accessed before initialization causing `TypeError: Cannot read properties of undefined`. Added early initialization and null guard in filter callback.
- Synced `page_template.py` from production (includes ML persistence gauge, per-aircraft smoothing)

## [1.3.1] - 2026-05-14: Repository Security Hardening
