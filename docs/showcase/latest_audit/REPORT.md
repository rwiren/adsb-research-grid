# 📡 ADS-B Grid Audit: 2026-01-12_1427

**Metadata:** `Git-SHA: bc9a402 | Date: 2026-01-12`

## 1. 📋 Executive Summary
| Metric | Value |
|---|---|
| **Data Start** | `2026-01-11 21:30 UTC` |
| **Data End** | `2026-01-12 12:26 UTC` |
| **Total Valid Samples** | **1,059,224** |
| **Active Sensors** | 2 |
| **Detected Anomalies** | **6,293** (1.00%) |
...
|:------------|----------:|----------:|
| sensor-east |    456684 |      43.1 |
| sensor-west |    602540 |      56.9 |

### 3.2 Signal Forensics (RSSI)
| sensor_id   |   mean |   max |   min |   std |
|:------------|-------:|------:|------:|------:|
| sensor-east | -31.97 |  -1.8 | -49.5 |  5.63 |
| sensor-west | -32.1  |  -2.7 | -49.5 |  5.32 |

### 3.3 Spatial Coverage
| sensor_id   |   distance_km |     alt |   hex |
|:------------|--------------:|--------:|------:|
| sensor-east |         836   | 24492.6 |   234 |
| sensor-west |         831.8 | 18385.3 |   242 |
...
|:-------|:-------------|-----------:|--------------:|-------:|:-------------|
| 4cae72 | sensor-north |      37000 |            54 |  -18.4 | 100.0%       |
| 4cae72 | sensor-north |      37000 |            54 |  -19.1 | 99.0%        |
| 4cae72 | sensor-north |      36975 |            54 |  -19.1 | 99.0%        |
| 4cae72 | sensor-north |      36975 |            54 |  -19.8 | 98.0%        |
| 4cae72 | sensor-north |      36975 |            54 |  -19.3 | 97.7%        |
