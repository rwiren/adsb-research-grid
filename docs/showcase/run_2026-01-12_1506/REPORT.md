# 📡 ADS-B Grid Audit: 2026-01-12_1506

**Metadata:** `Git-SHA: 532e42b | Date: 2026-01-12`

## 1. 📋 Executive Summary
| Metric | Value |
|---|---|
| **Data Start** | `2026-01-11 21:30 UTC` |
| **Data End** | `2026-01-12 13:05 UTC` |
| **Total Valid Samples** | **1,136,122** |
| **Active Sensors** | 2 |
| **Detected Anomalies** | **6,740** (1.00%) |
...
|:------------|----------:|----------:|
| sensor-east |    489341 |      43.1 |
| sensor-west |    646781 |      56.9 |

### 3.2 Signal Forensics (RSSI)
| sensor_id   |   mean |   max |   min |   std |
|:------------|-------:|------:|------:|------:|
| sensor-east | -31.99 |  -1.8 | -49.5 |   5.6 |
| sensor-west | -32.07 |  -2.7 | -49.5 |   5.4 |

### 3.3 Spatial Coverage
| sensor_id   |   distance_km |     alt |   hex |
|:------------|--------------:|--------:|------:|
| sensor-east |         836   | 24442.7 |   243 |
| sensor-west |         831.8 | 18152   |   253 |
...
|---------:|:-------------|-----------:|--------------:|-------:|:-------------|
| 4.61e+20 | sensor-north |      39000 |             8 |  -23   | 100.0%       |
| 4.61e+20 | sensor-north |      39000 |             8 |  -23   | 100.0%       |
| 4.61e+20 | sensor-north |      39000 |             8 |  -23   | 100.0%       |
| 4.61e+20 | sensor-north |      39000 |             8 |  -15.9 | 98.8%        |
| 4.61e+20 | sensor-north |      39000 |             8 |  -17.3 | 98.7%        |
