# 📡 ADS-B Grid Audit: 2026-01-12_2122
...
| **Data End** | `2026-01-12 19:20 UTC` |
| **Total Valid Samples** | **1,709,076** |
| **Active Sensors** | 2 |
| **Detected Anomalies** | **9,846** (1.00%) |
...
|:------------|----------:|----------:|
| sensor-east |    747572 |      43.7 |
| sensor-west |    961504 |      56.3 |

### 3.2 Signal Forensics (RSSI)
| sensor_id   |   mean |   max |   min |   std |
|:------------|-------:|------:|------:|------:|
| sensor-east | -32.02 |  -1.8 | -49.5 |  5.67 |
| sensor-west | -32.14 |  -2.7 | -49.5 |  5.37 |

### 3.3 Spatial Coverage
| sensor_id   |   distance_km |     alt |   hex |
|:------------|--------------:|--------:|------:|
| sensor-east |         836   | 24681.9 |   302 |
| sensor-west |         831.8 | 18338.2 |   317 |
...
| 4c01ed | sensor-north |      36025 |          10.2 |  -19.3 | 99.2%        |
| 4c01ed | sensor-north |      36025 |          10.2 |  -19.9 | 99.2%        |
