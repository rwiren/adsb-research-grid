# 📡 ADS-B Grid Audit: 2026-01-12_2259

**Metadata:** `Git-SHA: 0d98b3e | Date: 2026-01-12`

## 1. 📋 Executive Summary
| Metric | Value |
|---|---|
| **Data Start** | `2026-01-11 21:30 UTC` |
| **Data End** | `2026-01-12 20:14 UTC` |
| **Total Valid Samples** | **1,773,784** |
| **Active Sensors** | 2 |
...
|:------------|----------:|----------:|
| sensor-east |    771663 |      43.5 |
| sensor-west |   1002121 |      56.5 |

### 3.2 Signal Forensics (RSSI)
| sensor_id   |   mean |   max |   min |   std |
|:------------|-------:|------:|------:|------:|
| sensor-east | -32.01 |  -1.8 | -49.5 |  5.69 |
| sensor-west | -32.16 |  -2.7 | -49.5 |  5.37 |

### 3.3 Spatial Coverage
| sensor_id   |   distance_km |     alt |   hex |
|:------------|--------------:|--------:|------:|
| sensor-east |         836   | 24683.8 |   308 |
| sensor-west |         831.8 | 18353.6 |   323 |
