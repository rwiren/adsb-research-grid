# 📡 ADS-B Grid Audit: 2026-01-13_0035

**Metadata:** `Git-SHA: f45aa40 | Date: 2026-01-13`

## 1. 📋 Executive Summary
| Metric | Value |
|---|---|
| **Data Start** | `2026-01-11 21:30 UTC` |
| **Data End** | `2026-01-12 22:34 UTC` |
| **Total Valid Samples** | **1,695,663** |
| **Active Sensors** | 2 |
...
|:------------|----------:|----------:|
| sensor-east |    747288 |      44.1 |
| sensor-west |    948375 |      55.9 |

### 3.2 Signal Forensics (RSSI)
| sensor_id   |   mean |   max |   min |   std |
|:------------|-------:|------:|------:|------:|
| sensor-east | -32    |  -1.8 | -49.5 |  5.69 |
| sensor-west | -32.18 |  -2.7 | -49.5 |  5.34 |

### 3.3 Spatial Coverage
| sensor_id   |   distance_km |     alt |   hex |
|:------------|--------------:|--------:|------:|
| sensor-east |         836   | 24752.9 |   310 |
| sensor-west |         831.8 | 18516.6 |   324 |
