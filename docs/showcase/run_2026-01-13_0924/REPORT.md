# 📡 ADS-B Grid Audit: 2026-01-13_0924

**Metadata:** `Git-SHA: 6ea060c | Date: 2026-01-13`

## 1. 📋 Executive Summary
| Metric | Value |
|---|---|
| **Data Start** | `2026-01-11 21:30 UTC` |
| **Data End** | `2026-01-13 07:23 UTC` |
| **Total Valid Samples** | **697,047** |
| **Active Sensors** | 2 |
...
|:------------|----------:|----------:|
| sensor-east |    299781 |        43 |
| sensor-west |    397266 |        57 |

### 3.2 Signal Forensics (RSSI)
| sensor_id   |   mean |   max |   min |   std |
|:------------|-------:|------:|------:|------:|
| sensor-east | -32.22 |  -1.8 | -49.5 |  5.38 |
| sensor-west | -31.04 |  -2.5 | -49.5 |  5.39 |

### 3.3 Spatial Coverage
| sensor_id   |   distance_km |     alt |   hex |
|:------------|--------------:|--------:|------:|
| sensor-east |         836   | 24311.1 |   177 |
| sensor-west |         830.9 | 18216.6 |   166 |
