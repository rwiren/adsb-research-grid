# 📡 ADS-B Grid Audit: 2026-01-13_1608
...
| **Data End** | `2026-01-13 14:08 UTC` |
| **Total Valid Samples** | **1,256,288** |
| **Active Sensors** | 2 |
...
|:------------|----------:|----------:|
| sensor-east |    527106 |        42 |
| sensor-west |    729182 |        58 |

### 3.2 Signal Forensics (RSSI)
| sensor_id   |   mean |   max |   min |   std |
|:------------|-------:|------:|------:|------:|
| sensor-east | -32.19 |  -1.8 | -49.5 |  5.43 |
| sensor-west | -30.79 |  -2.5 | -49.5 |  5.58 |

### 3.3 Spatial Coverage
| sensor_id   |   distance_km |     alt |   hex |
|:------------|--------------:|--------:|------:|
| sensor-east |         837.1 | 24471.6 |   259 |
| sensor-west |         830.9 | 18045.5 |   258 |
